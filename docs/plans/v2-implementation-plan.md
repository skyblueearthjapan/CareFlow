...
| 日付 | バージョン | 内容 |
|---|---|---|
| 2026-05-05 | v0.1 | 初版。Wave 0〜6 チケット定義、並行実行マトリクス |
| 2026-05-05 | v0.2 | Codex レビュー反映。設計原則 §0 整備 |
| 2026-05-08 | v1.6 | Wave 18: Phase C ドキュメント整備完了を記録。BE (migration 0024 / place-and-fix 恒久対策 / cleanup script) + FE (複数・条件列再定義 / プール改善 / 配置移動 / 週間ビュー) |
