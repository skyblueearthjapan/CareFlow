...
- **資格×請求区分の不整合 月次棚卸（実績 CSV・9/10 21:34 取得分）**: 6 月 0 / 7 月 0 / 8 月 0 / **9 月 18**（W36 4 件 = 藤原 9/3・鈴木乃愛 9/3・唐鎌 9/4・伊藤 9/5、全て 高岡(准看)×正看・らく助送信の記録なし＝手作業起因 / W37 14 件）。らく助起因と特定できるのは 9/3 送信の edit 6 件（齋藤 9/8・岡村/園田/河野 9/10・藤江/武藤 9/11）。手順書を 25 件（実績 18 + 予定 7）に更新。**修正中（executor）**: diff engine で資格が変わる担当変更を delete+add 化・予実比較に「資格不整合」タグ。
